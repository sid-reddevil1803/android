...
public class Clubs extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   *
   * @param content the {@link com.appspot.campus_connect_2015.clubs.model.ModelsEventRequest}
   * @return the request
   */
  public EventEntry eventEntry(com.appspot.campus_connect_2015.clubs.model.ModelsEventRequest content) throws java.io.IOException {
    EventEntry result = new EventEntry(content);
    initialize(result);
    return result;
  }

  public class EventEntry extends ClubsRequest<Void> {
     ...
     * @since 1.13
     */
    protected EventEntry(com.appspot.campus_connect_2015.clubs.model.ModelsEventRequest content) {
      super(Clubs.this, "POST", REST_PATH, content, Void.class);
    }
  ...
  public class PostEntry extends ClubsRequest<Void> {
